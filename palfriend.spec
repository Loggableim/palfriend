...
"""
PyInstaller spec file for PalFriend Main Application (palfriend.exe)

This spec file configures PyInstaller to create the main PalFriend executable
...
# Create the executable as onedir for better stability
exe = EXE(
    pyz,
    a.scripts,
    [],
